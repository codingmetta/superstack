...
function SuperStackAboutSection() {
    return (
        <section className="relative flex flex-col items-center w-full h-full gap-40 px-4 pt-32 pb-24 overflow-hidden bg-white">
            <p className="z-20 w-1/3 text-5xl leading-[3.2rem] font-climate">you need new ears!</p>
            <img
            ...
            <div className="relative z-20 flex flex-col justify-around gap-4 px-6 py-5 bg-white border border-black min-w-min h-96 rounded-3xl ">
                ...
                <button className="absolute self-center whitespace-nowrap w-48 h-10 text-sm font-bold tracking-wider uppercase translate-x-0 border border-black translate-y-[11.725rem] rounded-3xl bg-limone ">Erfahre mehr</button>
            </div>
