...
function SuperStackAboutSection() {
    return (
        <section className="relative flex flex-col items-center w-full h-full gap-40 px-4 pt-32 pb-24 overflow-hidden bg-white lg:px-10 lg:pb-40 lg:justify-between lg:flex-row">
            <p className="z-20 w-1/3 lg:w-1/6 text-5xl leading-[3.2rem] font-climate">
                you need new ears!
            </p>
            <img
                className='absolute z-10 object-cover translate-x-[7.5rem] -translate-y-20 max-h-[27rem] lg:max-h-[34rem]'
