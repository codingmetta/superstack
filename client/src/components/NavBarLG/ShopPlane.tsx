...
function SubNavigationWrapper({ children }) {
    ...
    return (
        <div
            className="flex flex-col self-start w-full gap-2 tracking-wider uppercase ">
            {children}
        </div>
    );
}
...
function ShopPlane() {
    return (
        <PlaneWrapper>
            <div className='flex flex-row justify-between w-7/12 gap-44'>
            ...
            <figure className='relative w-5/12 overflow-hidden bg-white border border-black rounded-full h-2/3'>
                <img
                    className='object-fill -translate-y-80'
